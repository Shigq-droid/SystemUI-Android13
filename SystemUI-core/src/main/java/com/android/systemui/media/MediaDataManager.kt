...
class MediaDataManager(
    ...
    private fun createActionsFromState(
        ...
        val reservePrev = controller.extras?.getBoolean(
            androidx.media3.session.legacy.MediaConstants.SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_PREV) == true
        val reserveNext = controller.extras?.getBoolean(
            androidx.media3.session.legacy.MediaConstants.SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_NEXT) == true
    ...
    fun onNotificationRemoved(key: String) {
        ...
        if (useMediaResumption && removed?.resumeAction != null && removed?.isLocalSession() == true) {
